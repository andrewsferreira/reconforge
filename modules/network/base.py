"""ReconForge - Network Module Base Class

Author: Andrews Ferreira

Abstract base for all network reconnaissance phases.
...
class NetworkPhaseBase(ABC):
    """Base class for every network reconnaissance phase.
    ...
    def execute(self, target: str, **kwargs) -> dict[str, Any]:
        ...
        Args:
            target: The target IP / hostname / CIDR.
