"""ReconForge - Surface Module Base Class

Author: Andrews Ferreira

Abstract base for all attack-surface reconnaissance phases.
...
class SurfacePhaseBase(ABC):
    """Base class for every attack-surface reconnaissance phase.
