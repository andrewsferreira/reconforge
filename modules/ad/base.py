"""ReconForge - AD Module Base Class

Author: Andrews Ferreira

Abstract base for all Active Directory reconnaissance phases.
Mirrors the :class:`WebPhaseBase` pattern, providing shared access to
tools, parsers, and core services (findings, loot, workflow, notes, opsec).
"""
...
class ADPhaseBase(ABC):
    ...
    def execute(self, target: str, **kwargs) -> dict[str, Any]:
        ...
        Args:
            target: The target DC IP / hostname.
        ...
        try:
            results = self.run(target=target, **kwargs)
