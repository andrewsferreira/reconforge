"""ReconForge - Web Module Base Class

Author: Andrews Ferreira

Abstract base for all web reconnaissance phases.
...
class WebPhaseBase(ABC):
    """Base class for every web reconnaissance phase.
