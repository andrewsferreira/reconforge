...
- [ ] Wire `core/validators.py` into actual target parsing everywhere — §4 S9, §8 — *note: `core/target_parser.py` (the one actually used by network/ad/surface modules) already wires this in as of P0-6; remaining scope is any other bespoke validation call sites, not yet re-audited*
